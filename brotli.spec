...
Source0  : https://github.com/google/brotli/archive/v1.0.5.tar.gz
Summary  : Brotli encoder library
Group    : Development/Tools
License  : MIT
Requires: brotli-bin
Requires: brotli-lib
Requires: brotli-license
BuildRequires : cmake
BuildRequires : go
BuildRequires : pbr
BuildRequires : pip
...
export LANG=C
export SOURCE_DATE_EPOCH=1530196427
mkdir clr-build
pushd clr-build
...
export SOURCE_DATE_EPOCH=1530196427
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/brotli
cp LICENSE %{buildroot}/usr/share/doc/brotli/LICENSE
pushd clr-build
%make_install
popd
...
/usr/lib64/libbrotlicommon.so.1.0.5
/usr/lib64/libbrotlidec.so.1
/usr/lib64/libbrotlidec.so.1.0.5
/usr/lib64/libbrotlienc.so.1
/usr/lib64/libbrotlienc.so.1.0.5

%files license
%defattr(-,root,root,-)
/usr/share/doc/brotli/LICENSE
